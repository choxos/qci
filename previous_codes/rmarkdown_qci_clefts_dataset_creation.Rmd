---
title: "QCI of Orofacial Clefts"
author: "Erfan Shamsoddin, Ahmad Sofi-Mahmudi, Marcos Roberto Tovani-Palone"
date: "1/27/2022"
...
Creating a function named "create_data" to produce age-standardized QCI for every country and every year:
...
Next, we run the "create_data" function:
```{r}
create_data()
```
